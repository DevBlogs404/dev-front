    ...
    <div className="flex flex-col-reverse h-full gap-2 p-2 relative lg:flex-row lg:p-10 lg:gap-10">
      <div className="flex-1 h-full ">
        <form
          action=""
          method="post"
          className="flex p-6 flex-col items-center justify-center gap-8 lg:p-20"
        >
          ...
          <input
            ...
            id="name"
            placeholder="Name"
            className="p-2 rounded-lg text-black bg-gray-200 w-full"
          />
          <input
            type="email"
            name="email"
          ...
          <textarea
            ...
            rows="8"
            placeholder="Message"
            className="w-full rounded-lg bg-gray-200 text-black p-2"
            spellCheck={true}
          ></textarea>
          <button
            type="button"
